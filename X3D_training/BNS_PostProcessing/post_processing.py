#ref: https://github.com/wzmsltw/BSN-boundary-sensitive-network
...
def getDatasetDict():
    ...
    df = pd.read_csv('https://raw.githubusercontent.com/wzmsltw/BSN-boundary-sensitive-network/master/data/activitynet_annotations/video_info_new.csv')
    #json_data= load_json(r"./data/activitynet_annotations/anet_anno_action.json")
    json_data= load_json(r'https://github.com/wzmsltw/BSN-boundary-sensitive-network/blob/master/data/activitynet_annotations/anet_anno_action.json')
    database=json_data
    train_dict={}
    val_dict={}
    test_dict={}
...
for i in range(len(video_list)):
    ...
    print(video_info["duration_second"])
    proposal_list=[]
