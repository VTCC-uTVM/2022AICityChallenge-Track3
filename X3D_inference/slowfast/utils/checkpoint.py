...
def load_checkpoint(
    ...
    if convert_from_caffe2:
        ...
        if inflation:
            ...
            # pre_train_dict = torch.load('K400_MVIT_B_16x4_CONV_1.pyth')["model_state"]
...
def load_train_checkpoint(cfg, model, optimizer, scaler=None):
    ...
    if cfg.TRAIN.AUTO_RESUME and has_checkpoint(cfg.OUTPUT_DIR):
        ...
        checkpoint_epoch = load_checkpoint(
            last_checkpoint, model, cfg.NUM_GPUS > 1, optimizer, scaler=scaler, epoch_reset=cfg.TRAIN.CHECKPOINT_EPOCH_RESET,
        )
